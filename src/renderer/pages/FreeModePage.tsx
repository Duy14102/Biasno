...
import { useRecorder } from '../freeMode/useRecorder'
import { useFreePlayback } from '../freeMode/useFreePlayback'
import { buildMidi, buildMusicXml, buildSheetHtml } from '../freeMode/freeModeExport'
import {
  listEntries, getEntry, createEntry, updateEntry, deleteEntry,
  type LibraryEntry,
} from '../freeMode/library'
import FreeModeHeader from '../components/freeMode/FreeModeHeader'
import RecorderPanel  from '../components/freeMode/RecorderPanel'
import LibraryModal   from '../components/freeMode/LibraryModal'
...
import { KEYBOARD_HEIGHT } from '../practice/constants'
